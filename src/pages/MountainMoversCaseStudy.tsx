      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <div className="text-center fade-in">
            <h1 className="text-4xl font-bold mb-4">Mountain Movers</h1>
            <p className="text-xl text-gray-600">Elevating Moving Services in Austin, Texas</p>
          </div>
          ...
          <div className="glass-card rounded-lg p-8 slide-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600">Moving Services</p>
              </div>
              <div>
          ...
          <div className="glass-card rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-4 bg-white rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-3xl font-bold text-primary">19.8%</p>
              </div>
              <div className="p-4 bg-white rounded-lg shadow-sm border border-gray-100">
                <p className="text-sm text-gray-600 mb-1">Lead-to-Job Conversion</p>
          ...
          <div className="space-y-8">
            <div className="glass-card rounded-lg p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Mountain Movers faced several challenges in the competitive Austin moving market:
              </p>
              <ul className="list-disc list-inside mt-4 space-y-2 text-gray-600">
                <li>High competition in the Austin moving market</li>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Developed region-specific campaigns targeting high-value areas in Austin, with customized messaging and bid strategies.
                  </p>
                </div>
                <div>
                  <h3 className="font-medium text-gray-700 mb-2">Conversion Tracking</h3>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>31% Increase</TableCell>
          ...
          <div className="glass-card rounded-lg p-8 mb-12">
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Create a predictable lead generation system for moving businesses</li>
              </ul>
            </div>
          </div>
        </div>
